...
## 3.1 AWS 관리 콘솔(AWS Management Console)
...
## 3.3 AWS SDK(AWS Software Development Kit)
...
## 참고문헌
- What is AWS CLI? : https://docs.aws.amazon.com/ko_kr/cli/latest/userguide/cli-chap-welcome.html
